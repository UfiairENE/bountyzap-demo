...
class LightningStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SubscribeOnionMessages = channel.unary_stream(
                ...
                response_deserializer=lightning__pb2.OnionMessage.FromString,
                _registered_method=True)
...
def add_LightningServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SubscribeOnionMessages': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=lightning__pb2.OnionMessage.SerializeToString,
            ),
...
class Lightning(object):
    ...
    def SubscribeOnionMessages(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            lightning__pb2.OnionMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
